...
Table 3. \[\frac{\sum\nolimits_{n=1}^{NR} evals_{n}}{NR} = CR\] In this
measure \(evals\) denotes the number of evaluations done.
...
\[\frac{\sum\nolimits_{n=1}^{NR} NOF_{n}}{NKO * NR} = PR\] In this
measure \(NOF\) denotes the number of found optima per run and \(NKO\)
the number of known optima for the function.

...
set.caption('Success Ratio over given runs')
pander(sr)

```
```{r, Mean, echo=FALSE}
set.caption('Convergence Rates over given runs')
pander(mean)
```
...
```{r, trend curve of kept swarms over all 20 functions., echo = FALSE, dpi = 250, fig.ext='pdf', keep='all'}
# rm(list = ls())
# source("../R/cec_2015_problem_data.R")
# library(plyr)
# library(ggplot2)
